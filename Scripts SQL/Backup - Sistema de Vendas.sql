...
-- Copiando estrutura do banco de dados para dtb-sistema-vendas
CREATE DATABASE IF NOT EXISTS `dtb-sistema-vendas` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `dtb-sistema-vendas`;

-- Copiando estrutura para tabela dtb-sistema-vendas.cidade
...
-- Copiando dados para a tabela dtb-sistema-vendas.cidade: ~0 rows (aproximadamente)
...
-- Copiando estrutura para tabela dtb-sistema-vendas.cliente
...
-- Copiando dados para a tabela dtb-sistema-vendas.cliente: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `cliente` DISABLE KEYS */;
/*!40000 ALTER TABLE `cliente` ENABLE KEYS */;

-- Copiando estrutura para tabela dtb-sistema-vendas.compra
CREATE TABLE IF NOT EXISTS `compra` (
  ...
  KEY `fk_compra_funcionario1_idx` (`funcionario_id_funcionario`),
  ...
  CONSTRAINT `fk_compra_funcionario1` FOREIGN KEY (`funcionario_id_funcionario`) REFERENCES `funcionario` (`id_funcionario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela dtb-sistema-vendas.compra: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `compra` DISABLE KEYS */;
/*!40000 ALTER TABLE `compra` ENABLE KEYS */;

-- Copiando estrutura para tabela dtb-sistema-vendas.contas_receber
CREATE TABLE IF NOT EXISTS `contas_receber` (
  ...
  KEY `fk_contas_receber_venda1_idx` (`venda_id_venda`),
  CONSTRAINT `fk_contas_receber_venda1` FOREIGN KEY (`venda_id_venda`) REFERENCES `venda` (`id_venda`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela dtb-sistema-vendas.contas_receber: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `contas_receber` DISABLE KEYS */;
/*!40000 ALTER TABLE `contas_receber` ENABLE KEYS */;

-- Copiando estrutura para tabela dtb-sistema-vendas.contato
...
-- Copiando dados para a tabela dtb-sistema-vendas.contato: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `contato` DISABLE KEYS */;
/*!40000 ALTER TABLE `contato` ENABLE KEYS */;

-- Copiando estrutura para tabela dtb-sistema-vendas.conta_pagar
...
-- Copiando dados para a tabela dtb-sistema-vendas.conta_pagar: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `conta_pagar` DISABLE KEYS */;
/*!40000 ALTER TABLE `conta_pagar` ENABLE KEYS */;

-- Copiando estrutura para tabela dtb-sistema-vendas.endereco
...
-- Copiando dados para a tabela dtb-sistema-vendas.endereco: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `endereco` DISABLE KEYS */;
/*!40000 ALTER TABLE `endereco` ENABLE KEYS */;

-- Copiando estrutura para tabela dtb-sistema-vendas.estado
...
-- Copiando dados para a tabela dtb-sistema-vendas.estado: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `estado` DISABLE KEYS */;
INSERT INTO `estado` (`id_estado`, `codigo_uf`, `nome`, `uf`, `regiao_id_regiao`) VALUES
	(1, 12, 'Acre', 'AC', 1),
	(2, 27, 'Alagoas', 'AL', 2),
	(3, 13, 'Amazonas', 'AM', 1),
	(4, 16, 'Amapá', 'AP', 1),
	...
	(9, 52, 'Goiás', 'GO', 5),
	(10, 21, 'Maranhão', 'MA', 2),
	(11, 31, 'Minas Gerais', 'MG', 3),
	(12, 50, 'Mato Grosso do Sul', 'MS', 5),
	(13, 51, 'Mato Grosso', 'MT', 5),
	(14, 15, 'Pará', 'PA', 1),
	(15, 25, 'Paraíba', 'PB', 2),
	(16, 26, 'Pernambuco', 'PE', 2),
	(17, 22, 'Piauí', 'PI', 2),
	(18, 41, 'Paraná', 'PR', 4),
	...
	(21, 11, 'Rondônia', 'RO', 1),
	(22, 14, 'Roraima', 'RR', 1),
	(23, 43, 'Rio Grande do Sul', 'RS', 4),
	(24, 42, 'Santa Catarina', 'SC', 4),
	(25, 28, 'Sergipe', 'SE', 2),
	(26, 35, 'São Paulo', 'SP', 3),
	(27, 17, 'Tocantins', 'TO', 1);
/*!40000 ALTER TABLE `estado` ENABLE KEYS */;

-- Copiando estrutura para tabela dtb-sistema-vendas.estoque
CREATE TABLE IF NOT EXISTS `estoque` (
  ...
  KEY `fk_estoque_produto1_idx` (`produto_id_produto`),
  CONSTRAINT `fk_estoque_produto1` FOREIGN KEY (`produto_id_produto`) REFERENCES `produto` (`id_produto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela dtb-sistema-vendas.estoque: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `estoque` DISABLE KEYS */;
/*!40000 ALTER TABLE `estoque` ENABLE KEYS */;

-- Copiando estrutura para tabela dtb-sistema-vendas.fornecedor
...
-- Copiando dados para a tabela dtb-sistema-vendas.fornecedor: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `fornecedor` DISABLE KEYS */;
/*!40000 ALTER TABLE `fornecedor` ENABLE KEYS */;

-- Copiando estrutura para tabela dtb-sistema-vendas.funcionario
...
-- Copiando dados para a tabela dtb-sistema-vendas.funcionario: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `funcionario` DISABLE KEYS */;
/*!40000 ALTER TABLE `funcionario` ENABLE KEYS */;

-- Copiando estrutura para tabela dtb-sistema-vendas.item_compra
CREATE TABLE IF NOT EXISTS `item_compra` (
  ...
  KEY `fk_item_compra_produto1_idx` (`produto_id_produto`),
  KEY `fk_item_compra_compra1_idx` (`compra_id_compra`),
  CONSTRAINT `fk_item_compra_compra1` FOREIGN KEY (`compra_id_compra`) REFERENCES `compra` (`id_compra`),
  CONSTRAINT `fk_item_compra_produto1` FOREIGN KEY (`produto_id_produto`) REFERENCES `produto` (`id_produto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela dtb-sistema-vendas.item_compra: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `item_compra` DISABLE KEYS */;
/*!40000 ALTER TABLE `item_compra` ENABLE KEYS */;

-- Copiando estrutura para tabela dtb-sistema-vendas.item_venda
CREATE TABLE IF NOT EXISTS `item_venda` (
  ...
  CONSTRAINT `fk_item_venda_produto1` FOREIGN KEY (`produto_id_produto`) REFERENCES `produto` (`id_produto`),
  CONSTRAINT `fk_item_venda_venda1` FOREIGN KEY (`venda_id_venda`) REFERENCES `venda` (`id_venda`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela dtb-sistema-vendas.item_venda: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `item_venda` DISABLE KEYS */;
/*!40000 ALTER TABLE `item_venda` ENABLE KEYS */;

-- Copiando estrutura para tabela dtb-sistema-vendas.log_usuario
CREATE TABLE IF NOT EXISTS `log_usuario` (
  ...
  KEY `fk_log_usuario_funcionario1_idx` (`funcionario_id_funcionario`),
  CONSTRAINT `fk_log_usuario_funcionario1` FOREIGN KEY (`funcionario_id_funcionario`) REFERENCES `funcionario` (`id_funcionario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela dtb-sistema-vendas.log_usuario: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `log_usuario` DISABLE KEYS */;
/*!40000 ALTER TABLE `log_usuario` ENABLE KEYS */;

-- Copiando estrutura para tabela dtb-sistema-vendas.pessoa_fisica
...
-- Copiando dados para a tabela dtb-sistema-vendas.pessoa_fisica: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `pessoa_fisica` DISABLE KEYS */;
/*!40000 ALTER TABLE `pessoa_fisica` ENABLE KEYS */;

-- Copiando estrutura para tabela dtb-sistema-vendas.pessoa_juridica
...
-- Copiando dados para a tabela dtb-sistema-vendas.pessoa_juridica: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `pessoa_juridica` DISABLE KEYS */;
/*!40000 ALTER TABLE `pessoa_juridica` ENABLE KEYS */;

-- Copiando estrutura para tabela dtb-sistema-vendas.produto
...
-- Copiando dados para a tabela dtb-sistema-vendas.produto: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `produto` DISABLE KEYS */;
/*!40000 ALTER TABLE `produto` ENABLE KEYS */;

-- Copiando estrutura para tabela dtb-sistema-vendas.regiao
...
-- Copiando dados para a tabela dtb-sistema-vendas.regiao: ~0 rows (aproximadamente)
...
-- Copiando estrutura para tabela dtb-sistema-vendas.venda
CREATE TABLE IF NOT EXISTS `venda` (
  ...
  KEY `fk_venda_funcionario1_idx` (`funcionario_id_funcionario`),
  CONSTRAINT `fk_venda_cliente1` FOREIGN KEY (`cliente_id_cliente`) REFERENCES `cliente` (`id_cliente`),
  CONSTRAINT `fk_venda_funcionario1` FOREIGN KEY (`funcionario_id_funcionario`) REFERENCES `funcionario` (`id_funcionario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela dtb-sistema-vendas.venda: ~0 rows (aproximadamente)
