...
public class Valida {
     ...
     */
    public static boolean isInscricaoEstadualInvalida(String args) {
    ...
    /*
     * método para verificar se uma String está vazia
     */
    ...
    /*
     * método para verificar se o campo é do tipo inteiro
     */
    ...
    /*
     * método para validar seleção da comboBox
     */
    ...
    public static boolean validaEmail(String args) {
        Matcher matcher = VALID_EMAIL_ADDRESS_REGEX.matcher(args);
        return matcher.find();
    }
